...
/** CustomRecipes CustomRecipes <br>
 * The main class of Custom Recipes
 * @license Copyright (C) 2013 TheBoo This program is free software: you can
 ...
 * @author TheBoo */
@Mod(modid = Reference.MOD_ID, name = Reference.MOD_NAME, version = Reference.VERSION_NUMBER, dependencies = Reference.DEPENDENCIES, acceptableRemoteVersions = "*") public class CustomRecipes {
	
	public static net.minecraftforge.common.config.Configuration config;
	
	public RecipeLoader loader = new RecipeLoader();
	
	@Instance("customrecipes") public static CustomRecipes instance;
	
	@SidedProxy(clientSide = Reference.CLIENT_PROXY_CLASS, serverSide = Reference.SERVER_PROXY_CLASS) public static CommonProxy proxy;
	...
	@EventHandler public void load(FMLPostInitializationEvent fml) {
		System.out.println();
		System.out.println();
	...
	@EventHandler public void serverStarting(FMLServerStartingEvent event) {
		event.registerServerCommand(new CommandCItemInfo());
	}
